...
void InitGsm()
{
  ...
  WaitSim();                                    // wacht 6 seconden om de command door te voeren

  gsm.println("AT+CIFSR");                       // Command om het IP adress van de SIM900 te verkrijgen
  WaitSim();                                    // Wacht 2 seconden om command door te voeren
